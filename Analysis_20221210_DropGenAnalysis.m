...
% For loop to read the images of a folder

% Name of the folder path of images
myFolder = '/Users/kody/Documents/MATLAB/Lesher-Pérez/Images';


% Error Checking if myFolder is actually a folder
if ~isdir(myFolder)
...
% Parses all of the files that are jpg in the folder
...
for k = 1:length(jpegFiles)
    ...
    if k == length(jpegFiles) % Show the last image to reduce redundancy
